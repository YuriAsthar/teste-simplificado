...
- `FailureReason.php` — Reasons a transfer can fail (`insufficient_funds`, `payer_not_found`, `payee_not_found`, `invalid_amount`, `currency_mismatch`, `wallet_locked`, `idempotency_conflict`, `unknown`).
