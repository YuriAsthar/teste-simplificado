...
- `KafkaTransferService.php` — Operational service that publishes `transfer.completed` messages to Kafka using real `Transfer` IDs and dispatches notification jobs via RabbitMQ.
