...
final class TransferControllerTest extends TestCase
{
    ...
    public function test_it_returns_422_when_authorizer_rejects(): void
    {
        Http::fake([
            'https://util.devi.tools/api/v2/authorize' => Http::response([
                'data' => ['authorization' => false],
        ...
        $response = $this->postJson('/api/v1/transfer', [
            ...
            'Idempotency-Key' => 'authorizer-rejects-422',
        ]);
    ...
    public function test_replay_returns_cached_response_body_and_status(): void
    {
        Http::fake([
            'https://util.devi.tools/api/v2/authorize' => Http::response([
                'data' => ['authorization' => true],
